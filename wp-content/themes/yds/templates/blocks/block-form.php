                    ...
                    <div class="col-md-6 mb-5 mb-md-0">
                        ...
                        <?php if($text): ?>
                            <div class="contact-box">
                                <?= $text; ?>
                                <p class="m-0 contact-box-recaptcha">Deze site wordt beschermd door reCAPTCHA en de <a target="_blank" href="https://policies.google.com/privacy">Privacy Policy</a> en <a target="_blank" href="https://policies.google.com/terms">Terms of Service</a> van Google zijn van toepassing.</p>
                            </div>
                        <?php endif; ?>
                    </div>
